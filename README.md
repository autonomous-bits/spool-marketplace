...
- `spool` — work with Spool graphs using the `spl` CLI. Install Spool `spl` v1.9.0 or later and
...
Start a new Copilot session after installation and use `/skills list` to confirm the skills are
available.
